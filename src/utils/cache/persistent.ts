import type { LockInfo, UserInfo } from '/@app/model';
import type { ProjectConfig } from '/@/types/config';
import type { RouteLocationNormalized } from 'vue-router';

import { createLocalStorage, createSessionStorage } from '/@app/utils/cache';
...
import { DEFAULT_CACHE_TIME } from '/@app/settings/encryption';
