      ...
      <div class="flex h-full">
        <div class="hidden xl:flex xl:flex-col xl:w-6/12 min-h-full mr-4 pl-4">
          ...
          <div class="my-auto">
            <img
              :alt="title"
              src="/@app/assets/svg/login-box-bg.svg"
...
<script lang="ts">
  ...
  import { useI18n, useDesign } from '/@app/hooks/web';
  import { useLocaleStore } from '/@app/store/modules';
  import { AppLogo, AppLocalePicker, AppDarkModeToggle } from '/@app/components/Application';
...
<style lang="less">
  ...
  html[data-theme='dark'] {
    .@{prefix-cls} {
      ...
      &::before {
        background-image: url(/@app/assets/svg/login-bg-dark.svg);
      }
  ...
  .@{prefix-cls} {
    ...
    &::before {
      ...
      height: 100%;
      margin-left: -48%;
      background-image: url(/@app/assets/svg/login-bg.svg);
