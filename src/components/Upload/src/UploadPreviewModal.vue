...
<script lang="ts">
  ...
  //   import { BasicTable, useTable } from '/@app/components/Table';
  import { BasicModal, useModalInner } from '/@app/components/Modal';
  import { useI18n } from '/@app/hooks/web';
  import { downloadByUrl } from '/@app/utils/file/download';
