<script lang="tsx">
  ...
  import type { CollapseContainerOptions } from '/@app/components/Container/index';

  import { defineComponent, computed, ref, unref } from 'vue';
  import { Descriptions } from 'ant-design-vue';
  import { CollapseContainer } from '/@app/components/Container';
  import { useDesign } from '/@app/hooks/web';
  import { isFunction, getSlot } from '/@app/utils';
