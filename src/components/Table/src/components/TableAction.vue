...
<script lang="ts">
  ...
  import { useDesign, usePermission } from '/@app/hooks/web';
  import { propTypes } from '/@app/utils/common';
  import { isBoolean, isFunction } from '/@app/utils/common';
  import { ActionItem, TableActionType } from '/@app/components/Table';
  import { PopConfirmButton } from '/@app/components/Button';
