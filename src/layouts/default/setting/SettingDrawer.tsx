...
import { BasicDrawer } from '/@app/components/Drawer';
import { Divider } from 'ant-design-vue';
import { MenuTypeEnum, TriggerEnum } from '/@app/enums';
import {
  useRootSetting,
  useMenuSetting,
  useHeaderSetting,
...
} from '/@app/hooks/setting';
import { useI18n } from '/@app/hooks/web';
import { AppDarkModeToggle } from '/@app/components/Application';
import {
  TypePicker,
  ThemeColorPicker,
  SettingFooter,
