...
<script lang="ts">
  ...
  import { useGo } from '/@app/hooks/web';
  import { useMultipleTabStore } from '/@app/store/modules/multipleTab';
  import { useUserStore } from '/@app/store/modules/user';
  import { useDesign } from '/@app/hooks/web';
  import { useMultipleTabSetting } from '/@app/hooks/setting';
  import { REDIRECT_NAME } from '/@app/constants';
  import { listenerRouteChange } from '/@app/logics/mitt';
