...
<script lang="ts">
  ...
  import { useMenuSetting, useGlobSetting } from '/@app/hooks/setting';
  import { useDesign, useI18n, useGo } from '/@app/hooks/web/';
  import { SIDE_BAR_SHOW_TIT_MINI_WIDTH, SIDE_BAR_MINI_WIDTH } from '/@app/settings';
  import { getShallowMenus, getChildrenMenus, getCurrentParentPath } from '/@app/router/menus';
  import { listenerRouteChange } from '/@app/logics/mitt/routeChange';
  import { SimpleMenu } from '/@app/components/SimpleMenu';
  import { ScrollContainer } from '/@app/components/Container';
  import { SimpleMenuTag } from '/@app/components/SimpleMenu';
